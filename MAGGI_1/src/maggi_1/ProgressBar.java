...
public class ProgressBar extends javax.swing.JFrame {
                   ...
                   while(thread_progress.isAlive()){
                        ...
                        for(int i=0;i<15;i++){
                            ...
                            if(file_image.exists()){
                                ...
                                if(jLabel1!=null)
                                {
                                    jPanelProgressImages.remove(jLabel1);
                                    jLabel1=null;
                                }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/maggi_1/icons/maggi_search.JPG"))); // NOI18N
        jPanelProgressImages.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 490, 150));
        ...
        jLabel2.setText("NOTE: To Abort Search Close Grid View or Close Maggi Learning");
        jLabel2.setOpaque(true);
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 350, -1));
